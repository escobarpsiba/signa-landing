...
const appCss = "/assets/styles-CF7uVw3y.css";
...
const $$splitComponentImporter = () => import("./index-bue30svG.mjs");
const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Plataforma elegante para psicanalistas gerenciarem agenda, pacientes, pagamentos e rotina com apoio de IA."
    }]
  })
});
